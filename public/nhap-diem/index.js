...
let updiem = document.getElementById("up-diem");
let diem = document.getElementById("grade");
let diemphu = document.getElementById("subGrade");
...
updiem.addEventListener("click", function(){
    wait.innerText = "Đang xử lý...";
    wait.style.color = "black";
    wait.style.display = "block";
    if(mathisinh.value && diem.value){
        try {
...
const setupUI = (user) => {
  if (user != null) {
        ...
        document.getElementById("nhap-diem").style.display = "none";
